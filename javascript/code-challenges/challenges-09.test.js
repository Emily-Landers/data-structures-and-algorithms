...
const updateNumbers = (obj) => Object.entries(obj).map(str => str.join(': '));
...
const getHouses = (arr) => arr.map(info => info.house);
...
const hasChildrenValues = (arr, character) => Object.values(arr).includes(character);
